...
export async function GET() {
  ...
  if (role == 'Admin') {
    ...
    return NextResponse.json([
      {
        room_id: 'R101',
        admission_date: '2024-06-08T08:00:00Z',
        discharge_date: null, // still admitted
      },
      {
        room_id: 'R102',
        admission_date: '2024-06-09T10:00:00Z',
        discharge_date: '2024-06-11T15:00:00Z', // already discharged
      },
      // R205 is empty
