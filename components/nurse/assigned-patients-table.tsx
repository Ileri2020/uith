...
const AssignedPatientsTable: React.FC<AssignedPatientsTableProps> =  ({ admissionslst, onRowClick }: { admissionslst: any[], onRowClick: (patient: any) => void }) => {
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-xs text-muted-foreground">
          Patients currently assigned to your care: {admissions.length}, select patient for details
        </CardDescription>
      </CardHeader>
